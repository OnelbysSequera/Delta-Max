...
CREATE TABLE `detalle_producto` (
  ...
  `caracteristicas_producto` varchar(50) DEFAULT NULL,
...
INSERT INTO `detalle_producto` (`id_detalleProducto`, `nombre_producto`, `caracteristicas_producto`, `id_marca`) VALUES
(0, 'Lapiz', 'Amarillo', 0);
...
CREATE TABLE `formapago` (
  `id_formaPago` int(11) NOT NULL,
  `forma_pago` varchar(55) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `linea_telefono`
--

CREATE TABLE `linea_telefono` (
  `id_linea` int(11) NOT NULL,
  `linea` varchar(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `linea_telefono`
--

INSERT INTO `linea_telefono` (`id_linea`, `linea`) VALUES
(1, '(0412)'),
(2, '(0416)'),
(3, '(0424)'),
(4, '(0426)');
...
CREATE TABLE `nacionalidad` (
  ...
  `tipo_nacionalidad` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `nacionalidad` (`id_nacionalidad`, `tipo_nacionalidad`) VALUES
(1, 'CÉDULA DE IDENTIDAD'),
(2, 'CÉDULA EXTRANJERA'),
(3, 'RIF PERSONA NATURAL'),
(4, 'RIF PERSONA JURÍDICA'),
(5, 'PASAPORTE'),
(6, 'RIF-E'),
(7, 'RIF-V'),
(8, 'RIF-G');
...
CREATE TABLE `pedido` (
  ...
  `precio` float NOT NULL,
  `id_formaPago` int(11) NOT NULL,
  `direccionEnvio` varchar(55) NOT NULL,
...
--
-- Indices de la tabla `linea_telefono`
--
ALTER TABLE `linea_telefono`
...
ALTER TABLE `usuariociente`
  ...
  ADD KEY `id_nacionalidadCliente` (`id_nacionalidadCliente`),
  ADD KEY `id_sexo` (`id_sexo`),
  ADD KEY `id_codigoLinea` (`id_codigoLinea`),
  ADD KEY `id_estado` (`id_estado`),
...
--
-- AUTO_INCREMENT de la tabla `linea_telefono`
--
ALTER TABLE `linea_telefono`
...
--
ALTER TABLE `nacionalidad`
  MODIFY `id_nacionalidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`id_formaPago`) REFERENCES `formapago` (`id_formaPago`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `usuariociente`
  ADD CONSTRAINT `usuariociente_ibfk_1` FOREIGN KEY (`id_nacionalidadCliente`) REFERENCES `nacionalidad` (`id_nacionalidad`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `usuariociente_ibfk_2` FOREIGN KEY (`id_sexo`) REFERENCES `sexo` (`id_sexo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `usuariociente_ibfk_3` FOREIGN KEY (`id_parroquia`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `usuariociente_ibfk_4` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `usuariociente_ibfk_5` FOREIGN KEY (`id_ciudad`) REFERENCES `ciudades` (`id_ciudad`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `usuariociente_ibfk_6` FOREIGN KEY (`id_codigoLinea`) REFERENCES `linea_telefono` (`id_linea`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `usuariociente_ibfk_7` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
