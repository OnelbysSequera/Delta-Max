...
<body>
    ...
    <nav class="navegacion">
      ...
      <main class="contenedor">
        <h1 class="titulo">Productos para Manualidades</h1>
        ...
        <div class="container mt-4">
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="border border-dark border-2 p-4" style="background-color: lightpink;">
                        <img src="img/P1-M.png" class="img-fluid imagen-fija" alt="Imagen 1">
                        <h3>Caja de colores (64) Crayola: <span class="badge bg-primary">7$</span></h3>
                        <p class="texto__producto">Click para ver detalles del producto.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="border border-dark border-2 p-4" style="background-color: lightpink;">
                        <img src="img/P2-M.png" class="img-fluid imagen-fija" alt="Imagen 2">
                        <h3>Caja de colores (12) Crayola: <span class="badge bg-primary">3$</span></h3>
                        <p class="texto__producto">Click para ver detalles del producto.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="border border-dark border-2 p-4" style="background-color: lightpink;">
                        <img src="img/P3-M.png" class="img-fluid imagen-fija" alt="Imagen 3">
                        <h3>Pinturas lavables Crayola: <span class="badge bg-primary">4$</span></h3>
                        <p class="texto__producto">Click para ver detalles del producto.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-4">
                <div class="col-md-4 mb-4">
                    <div class="border border-dark border-2 p-4" style="background-color: lightpink;">
                        <img src="img/P4-M.png" class="img-fluid imagen-fija" alt="Imagen 4">
                        <h3>Pegamento lavable Crayola: <span class="badge bg-primary">3$</span></h3>
                        <p class="texto__producto">Click para ver detalles del producto.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="border border-dark border-2 p-4" style="background-color: lightpink;">
                        <img src="img/P5-M.png" class="img-fluid imagen-fija" alt="Imagen 5">
                        <h3>Plumones lavables Crayola: <span class="badge bg-primary">5$</span></h3>
                        <p class="texto__producto">Click para ver detalles del producto.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="border border-dark border-2 p-4" style="background-color: lightpink;">
                        <img src="img/P6-M.png" class="img-fluid imagen-fija" alt="Imagen 6">
                        <h3>Plastilina Crayola:  <span class="badge bg-primary">6$</span></h3>
                        <p class="texto__producto">Click para ver detalles del producto.</p>
                    </div>
                </div>
            </div>
